...
export const PLACEHOLDER_COURSES: Course[] = [
  ...
  },
  {
    ...
    syllabusOverview: ['Introduction to Machine Learning & Real-World Use Cases', 'Python for ML: Numpy, Pandas, Matplotlib', 'Data Preprocessing & Feature Engineering', 'Supervised Learning: Linear & Logistic Regression', 'Unsupervised Learning: K-Means, PCA', 'Decision Trees, Random Forests & Ensemble Methods', 'Model Evaluation\,Tuning & Cross Validation' ,'Neural Networks & Deep Learning Basics','Real-Life ML Projects (Regression & Classification)','Capstone Project + Deployment Guidance'],
    duration: '4/6 Months Course',
