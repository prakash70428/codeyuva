...
export const PLACEHOLDER_COURSES: Course[] = [
  {
    ...
    syllabusOverview: ['Java Fundamentals & OOP Principles', 'Arrays, Strings & StringBuilder', 'Recursion, Backtracking & Divide-Conquer', 'Sliding Window, Two Pointer & Prefix Sum', 'Sorting, Searching & Time/Space Complexity', 'Stack, Queue, Linked List & Deque', 'Trees, BST & Segment Trees', 'Heaps, Hashing & HashMap Internals', 'Graphs: BFS, DFS, Dijkstra & Topological Sort', 'Dynamic Programming (Patterns + LeetCode Top 50)', 'Bitmasking, Greedy & System Design Basics', 'Mock Interviews & Company-wise Problem Sets'],
    duration: '4 Months if you grind daily · 6 Months if you balance it with college or job — you pick the pace',
    whoShouldJoin: ['College students tired of theory who want to crack real product company interviews', 'Freshers who feel lost on LeetCode and need a structured path from zero', 'Working professionals who missed DSA in college and now want to switch to top-tier tech roles'],
    image: 'https://images.unsplash.com/photo-1484807352052-23338990c6c6?w=800&q=80',
    dataAiHint: 'student studying laptop night',
    originalFee: 30000,
    discountedFee: 25500,
  ...
  },
  {
    ...
    syllabusOverview: ['HTML5, CSS3 & Responsive Design', 'Tailwind CSS & Component-First Thinking', 'JavaScript ES6+ & TypeScript Essentials', 'React.js with Hooks, Context & React Query', 'Next.js 14 — App Router, SSR & SSG', 'Git, GitHub & CI/CD Workflows', 'Node.js & Express.js — REST API Design', 'MongoDB, Mongoose & Database Modelling', 'JWT Auth, Middleware & Security Best Practices', 'Docker Basics & Cloud Deployment (Vercel/Render)', '3 Full-Stack Live Projects with Source Code', 'Resume & LinkedIn Profile Review'],
    duration: '6 Months to go from zero to deployed — 3 live projects in your portfolio before you even graduate',
    whoShouldJoin: ['Students who want to build real apps and show them in interviews, not just watch tutorials', 'Freshers with no prior coding experience who want a job-ready full-stack portfolio in 6 months', 'Anyone who has started learning web dev 10 times but never finished — this is the structured push you need'],
    image: 'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=800&q=80',
    dataAiHint: 'students collaborating laptops team project',
    originalFee: 30000,
    discountedFee: 25500,
    discountPercentage: 15,
  },
  {
    ...
    syllabusOverview: ['Python for ML: NumPy, Pandas & Matplotlib', 'Data Preprocessing, EDA & Feature Engineering', 'Supervised Learning: Regression & Classification', 'Unsupervised Learning: Clustering & Dimensionality Reduction', 'Decision Trees, Random Forests & XGBoost', 'Model Evaluation, Cross-Validation & Hyperparameter Tuning', 'Neural Networks & Deep Learning with TensorFlow/Keras', 'Computer Vision Basics: CNNs & OpenCV', 'NLP & Large Language Models (LLMs) with Hugging Face', 'GenAI & LangChain: Build RAG Applications', 'MLOps: Model Deployment with FastAPI & Docker', 'Capstone Project: End-to-End ML Product'],
    duration: '5 Months · Because AI moves fast and so will you — hands-on from Week 1, job-ready by the end',
    whoShouldJoin: ['Students curious about AI who want to go beyond YouTube videos and build real ML projects', 'Graduates and working professionals who see AI taking over every industry and want to stay ahead', 'Developers and analysts who know basic Python and want to enter the Data Science & GenAI space seriously'],
    image: 'https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=800&q=80',
    dataAiHint: 'student curious learning discovery technology',
    originalFee: 30000,
    discountedFee: 25500,
    discountPercentage: 15,
  },
