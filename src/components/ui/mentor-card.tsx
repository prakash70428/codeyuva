...
export function MentorCard({ mentor }: MentorCardProps) {
  return (
    <div className="perspective group h-[400px]">
      <Card className="relative preserve-3d w-full h-full shadow-lg transition-all duration-700 group-hover:[transform:rotateY(180deg)] bg-card border-border/50 hover:border-primary/30 hover:shadow-primary/10 hover:shadow-xl">
        {/* Front */}
        <div className="absolute backface-hidden w-full h-full flex flex-col items-center justify-center p-6 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-3 italic opacity-60">Hover for details</p>
        </div>
        ...
        <div className="absolute [transform:rotateY(180deg)] backface-hidden w-full h-full flex flex-col justify-between p-6 bg-card rounded-xl overflow-y-auto">
          ...
          <CardFooter className="p-0 mt-4">
            <Button asChild variant="outline" className="w-full hover:bg-primary/10 hover:border-primary border-border text-primary">
